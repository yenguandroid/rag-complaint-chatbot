...
Framework : Gradio
Author    : github.com/yenguandroid/rag-complaint-chatbot
"""
...
def answer_question(question: str, history: list):
    if not question.strip():
        return "", "<p style='color:gray;'>Please enter a question.</p>", history
    ...
    for i, src in enumerate(sources[:5], 1):
        ...
        <div style='border:1px solid #3B82F6; border-left:4px solid #3B82F6;
            ...
            <div style='font-size:12px; color:#374151; margin-bottom:8px;'>
                🏷️ <b>Product:</b> {src.get('product_category','N/A')} &nbsp;|&nbsp;
                🏢 <b>Company:</b> {src.get('company','N/A')} &nbsp;|&nbsp;
    ...
    # ✅ NEW: dict format required by Gradio messages type
...
with gr.Blocks(
    ...
    css="""
        ...
        #ask-btn   { background: #1E40AF !important; color: white !important; }
        #clear-btn { background: #EF4444 !important; color: white !important; }
        .source-box { max-height: 500px; overflow-y: auto; }
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            ...
            chatbot = gr.Chatbot(
                ...
                placeholder="<div style='text-align:center; color:#9CA3AF; padding:40px;'>"
                            "<h3>👋 Welcome!</h3>"
        ...
        with gr.Column(scale=2):
            ...
            gr.Markdown(
                "*The complaint excerpts used to generate the answer above.*",
                elem_classes=["source-box"]
            )
            sources_display = gr.HTML(
                value="<p style='color:gray; font-style:italic; padding:20px;'>"
                      "Sources will appear here after your first question.</p>",
                label="",
            )
    ...
    ask_btn.click(
        ...
        outputs=[question_box, sources_display, history_state],
    ).then(
        fn=lambda h: h,
    ...
    clear_btn.click(
        fn=clear_all,
        inputs=[],
        outputs=[history_state, sources_display, question_box],
    ).then(
        fn=lambda h: h,
        inputs=[history_state],
        outputs=[chatbot],
